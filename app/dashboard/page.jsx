...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setUser({
        firstName: 'John', // This would come from your database
        lastName: 'Doe',
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Projects Applied</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow">
              ...
              <div className="p-6">
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">Start by completing your profile to get discovered by top companies.</p>
